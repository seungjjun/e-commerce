...
class OrderIntegrationTest {
	...
	@Test
	@DisplayName("주문 성공 통합 테스트")
	void success_order_test() {
		// Given
		Long userId = 1L;
		Long productId = 1L;
		...
		// 사용자 포인트 차감 확인
		assertThat(user.point()).isEqualTo(5000L - 1000L);

		// 상품 재고 차감 확인
		assertThat(product.stockQuantity()).isEqualTo(5L - 1L);
		assertThat(stocks.size()).isEqualTo(1);
		assertThat(stocks.get(0).stockQuantity()).isEqualTo(5L - 1L);
	}
...
//
//		// Then
//		assertThat(foundUser.point()).isEqualTo(2_000);
